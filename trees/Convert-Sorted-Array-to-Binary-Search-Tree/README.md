...
Cho một mảng số nguyên `nums` trong đó các phần tử được sắp xếp theo thứ tự từ nhỏ đến lớn, chuyển đổi nó thành một **cây nhị phân tìm kiếm cân bằng**.

Một cây nhị phân tìm kiếm cân bằng là một cây mà chênh lệch chiều sâu giữa hai cây con của tất cả nút không quá một.
...
<strong>Giải thích:</strong> [0,-10,5,null,-3,null,9] biểu diễn cây như sau:
...
<strong>Explanation:</strong> Cả [1,3] và [3,1] đều là cây nhị phân tìm kiếm cân bằng.
